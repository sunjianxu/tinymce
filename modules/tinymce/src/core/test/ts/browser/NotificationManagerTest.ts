...
describe('browser.tinymce.core.NotificationManagerTest', () => {
  Arr.each([
    ...
    context(tester.label, () => {
      ...
      it('TestCase-TBA: Should not add duplicate text message', () => {
        const editor = hook.editor();
      ...
      it('TestCase-TBA: Should add duplicate progressBar messages', () => {
        const editor = hook.editor();
      ...
      it('TestCase-TBA: Should add duplicate timeout messages', (done) => {
        const editor = hook.editor();
        const checkClosed = () => {
      ...
      it('TestCase-TINY-6058: Should move focus back to the editor when all notifications closed', () => {
        const editor = hook.editor();
      ...
      it('TestCase-TBA: Should not open notification if editor is removed', () => {
        const editor = hook.editor();
