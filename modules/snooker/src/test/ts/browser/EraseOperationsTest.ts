...
UnitTest.test('EraseOperationsTest', () => {
  ...
  const deleteExpectedContent29 = generateTestTable(
    ...
    [], [],
    { numCols: 2, colgroup: true, lockedColumns: [ 0, 2 ] } // TODO: should the locked columns indexes be changed in the table attribute as result of erasing other columns? Should snooker not have to worry about this
  );
