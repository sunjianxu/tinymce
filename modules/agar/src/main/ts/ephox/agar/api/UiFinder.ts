...
const pWaitFor = (message: string, container: SugarElement<Element>, selector: string): Promise<SugarElement<Element>> =>
  Chain.toPromise(cWaitFor(message, selector))(container);

const pWaitForVisible = (message: string, container: SugarElement<Element>, selector: string): Promise<SugarElement<Element>> =>
  Chain.toPromise(cWaitForVisible(message, selector))(container);

const pWaitForHidden = (message: string, container: SugarElement<Element>, selector: string): Promise<SugarElement<Element>> =>
